...
<body>
	...
	<a href="#" id="deleteProfessor" data-profno="${output.profno}" data-name="${output.name}" 
	data-position="${output.position}">[교수삭제]</a>
    		...
    		$.delete("${pageContext.request.contextPath}/professor",{
    			"profno": profno
    				...
    				if (json.rt =="OK"){
    					alert("삭제되었습니다.");
    					// 삭제 완료 후 목록 페이지로 이동
    					window.location = "${pageContext.request.contextPath}/professor/list.do";
    				}
    		});
    	});    	
    });
