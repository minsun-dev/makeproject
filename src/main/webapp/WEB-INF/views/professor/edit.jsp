...
<body>
	...
	<form id="editForm" action="${pageContext.request.contextPath}/professor">
		...
		<div>
			...
			<input type="range" name="comm" id="comm" min="0" max="100" value="${output.comm}"/>			
		</div>
		<div>
    	...
    	$(function(){
    		...
    		$("#editForm").ajaxForm({
    			...
    			success: function(json){
    				...
    				if(json.rt == "OK"){
    					window.location="${pageContext.request.contextPath}/professor/view.do?profno=" + json.item.profno;
    				}
    			}
    		});
    	});
